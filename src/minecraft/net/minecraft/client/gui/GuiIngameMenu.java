...
public class GuiIngameMenu extends GuiScreen
{
     ...
     public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("instinct/testlogo.png"));
        Gui.drawModalRectWithCustomSizedTexture(this.width/2-47, this.height/2-150, 0, 0, 100, 100, 100, 100);
